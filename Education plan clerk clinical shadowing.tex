...
\subsection{週五（9月5日）- 超音波實習 + 床邊超音波}
...
\hline
\rowcolor{light_blue}
\textbf{技能項目} & \textbf{第1週} & \textbf{第2週} & \textbf{達成} & \textbf{備註} \\
\hline
心臟超音波基本操作 & $\square$ & $\square$ & $\square$ & 包含機器調整、探頭使用 \\
\hline
Apical 4-chamber view & $\square$ & $\square$ & $\square$ & 標準切面獲取 \\
\hline
Parasternal long axis view & $\square$ & $\square$ & $\square$ & 影像最佳化 \\
\hline
Parasternal short axis view & $\square$ & $\square$ & $\square$ & 多層面掃描 \\
\hline
Subcostal view & $\square$ & $\square$ & $\square$ & 下腔靜脈評估 \\
\hline
彩色都卜勒應用 & $\square$ & $\square$ & $\square$ & 血流評估技術 \\
\hline
週邊血管超音波 & $\square$ & $\square$ & $\square$ & 頸動脈、下肢血管 \\
\hline
DVT檢查技術 & $\square$ & $\square$ & $\square$ & 壓迫試驗 \\
\hline
PAOD評估 & $\square$ & $\square$ & $\square$ & ABI測量 \\
\hline
床邊緊急超音波 & $\square$ & $\square$ & $\square$ & RUSH protocol \\
\hline
\end{longtable}
...
\textbf{技能項目} & \textbf{第1週} & \textbf{第2週} & \textbf{達成} & \textbf{備註} \\
\hline
無菌技術操作 & $\square$ & $\square$ & $\square$ & 刷手、穿無菌衣 \\
\hline
動脈穿刺觀摩 & $\square$ & $\square$ & $\square$ & 橈動脈、股動脈 \\
\hline
靜脈穿刺練習 & $\square$ & $\square$ & $\square$ & 中心靜脈穿刺 \\
\hline
導管操作基礎 & $\square$ & $\square$ & $\square$ & 導絲、導管選擇 \\
\hline
造影技術理解 & $\square$ & $\square$ & $\square$ & 角度選擇、對比劑 \\
\hline
血流動力學監測 & $\square$ & $\square$ & $\square$ & 壓力測量、心輸出量 \\
\hline
IVUS/OCT操作觀摩 & $\square$ & $\square$ & $\square$ & 血管內影像 \\
\hline
併發症識別 & $\square$ & $\square$ & $\square$ & 穿刺併發症、對比劑反應 \\
\hline
術後照護 & $\square$ & $\square$ & $\square$ & 止血、監測 \\
\hline
緊急處置參與 & $\square$ & $\square$ & $\square$ & STEMI處理流程 \\
\hline
\end{longtable}
