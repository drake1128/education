...
\vspace{0.5cm}
\note{
胸腔內科EPAs評量著重於能否安全、穩定地執行完整的呼吸系統疾病診療流程，並能整合資訊做出適當臨床決策。每個EPA都包含明確的里程碑發展階段，從初學者到專家的完整能力建構。本次更新將EPAs擴展至14個，新增結核病、非典型分枝桿菌感染、肺癌診療，以及間質性肺病管理等重要領域。
}
...
\begin{itemize}[nosep]
    ...
    \item 操作支氣管內視鏡檢查。
    \item 協調胸腔科病患整體照護。
    \item \textcolor{emergency_red}{\textbf{診斷與治療結核病及其併發症。}}
    \item \textcolor{emergency_red}{\textbf{管理非典型分枝桿菌感染。}}
    \item \textcolor{emergency_red}{\textbf{執行肺癌診斷與分期評估。}}
    \item \textcolor{emergency_red}{\textbf{診斷與治療間質性肺疾病。}}
\end{itemize}
...
\newpage
\section{胸腔內科14大EPAs詳述}

\begin{longtable}{|p{1.2cm}|p{3.8cm}|p{8.5cm}|}
\caption{胸腔內科EPAs完整架構（擴展版）} \\
\hline
...
\rowcolor{emergency_red!10}
\multicolumn{3}{|c|}{\textcolor{emergency_red}{\textbf{EPA 11: 結核病診斷與治療管理}}} \\
\hline
\textbf{描述} & \multicolumn{2}{|p{12.5cm}|}{能夠診斷各型結核病，評估傳染性與嚴重度，執行標準抗結核治療，監測治療反應與副作用，並處理抗藥性結核病及其併發症。} \\
\hline
\textbf{核心能力} & 診斷策略 & 痰液檢查、IGRA、分子診斷技術 \\
\cline{2-3}
& 影像評估 & 典型肺結核影像、粟粒性結核識別 \\
\cline{2-3}
& 治療方案 & 第一線抗結核藥物組合、療程規劃 \\
\cline{2-3}
& 副作用監測 & 肝毒性、視神經炎、皮疹監測 \\
\cline{2-3}
& 抗藥性處理 & MDR-TB識別、二線藥物應用 \\
\cline{2-3}
& 感染控制 & 隔離措施、接觸者追蹤 \\
\cline{2-3}
& 併發症處理 & 血胸、支氣管胸膜瘻、毀損肺 \\
\hline
\textbf{Level 1} & Novice & 能識別結核病症狀，知道基本診斷檢查 \\
\hline
\textbf{Level 2} & Advanced Beginner & 能執行標準診斷流程，開始第一線治療 \\
\hline
\textbf{Level 3} & Competent & 能獨立管理典型肺結核，監測治療反應 \\
\hline
\textbf{Level 4} & Proficient & 能處理複雜結核病，評估抗藥性治療 \\
\hline
\textbf{Level 5} & Expert & 成為結核病專家，管理MDR-TB與併發症 \\
\hline

\rowcolor{emergency_red!10}
\multicolumn{3}{|c|}{\textcolor{emergency_red}{\textbf{EPA 12: 非典型分枝桿菌感染診斷與管理}}} \\
\hline
\textbf{描述} & \multicolumn{2}{|p{12.5cm}|}{能夠診斷非典型分枝桿菌感染，區分致病性與定植，執行適當的抗分枝桿菌治療，並管理治療相關併發症與抗藥性問題。} \\
\hline
\textbf{核心能力} & 菌種識別 & MAC、M. kansasii、快速生長菌分類 \\
\cline{2-3}
& 診斷標準 & ATS診斷標準應用、致病性判定 \\
\cline{2-3}
& 影像特徵 & 結節支氣管擴張型、空洞型識別 \\
\cline{2-3}
& 治療決策 & 治療指標、藥物選擇、療程規劃 \\
...
& 追蹤監測 & 治療反應評估、復發監測 \\
\hline
\textbf{Level 1} & Novice & 能識別NTM可能性，了解基本檢查 \\
\hline
\textbf{Level 2} & Advanced Beginner & 能應用診斷標準，區分致病性與定植 \\
\hline
\textbf{Level 3} & Competent & 能獨立診斷NTM感染，制定治療計畫 \\
\hline
\textbf{Level 4} & Proficient & 能處理難治NTM感染，整合內外科治療 \\
\hline
\textbf{Level 5} & Expert & 成為NTM專家，處理複雜抗藥性個案 \\
\hline

\rowcolor{emergency_red!10}
\multicolumn{3}{|c|}{\textcolor{emergency_red}{\textbf{EPA 13: 肺癌診斷與分期評估}}} \\
\hline
\textbf{描述} & \multicolumn{2}{|p{12.5cm}|}{能夠診斷肺癌，執行完整分期評估，協調多專科團隊照護，參與治療決策討論，並提供病患與家屬適當的衛教與支持。} \\
\hline
\textbf{核心能力} & 早期偵測 & 肺癌篩檢、危險因子評估 \\
\cline{2-3}
& 病理診斷 & 組織取得途徑、細胞型態分類 \\
\cline{2-3}
& 分期評估 & TNM分期、影像學評估、侵襲性檢查 \\
\cline{2-3}
& 分子檢測 & EGFR、ALK、PD-L1檢測判讀 \\
\cline{2-3}
& 功能評估 & 手術適應性、心肺功能評估 \\
\cline{2-3}
& 多科整合 & 腫瘤團隊討論參與、治療計畫制定 \\
\cline{2-3}
& 症狀緩解 & 呼吸困難、疼痛、惡病質處理 \\
\hline
\textbf{Level 1} & Novice & 能識別肺癌可疑症狀，知道基本檢查流程 \\
\hline
\textbf{Level 2} & Advanced Beginner & 能執行分期檢查，參與團隊討論 \\
\hline
\textbf{Level 3} & Competent & 能獨立完成肺癌分期，制定初步治療計畫 \\
\hline
\textbf{Level 4} & Proficient & 能整合複雜檢查結果，協調多科治療 \\
\hline
\textbf{Level 5} & Expert & 成為肺癌專家，領導多科團隊照護 \\
\hline

\rowcolor{emergency_red!10}
\multicolumn{3}{|c|}{\textcolor{emergency_red}{\textbf{EPA 14: 間質性肺疾病診斷與治療}}} \\
\hline
\textbf{描述} & \multicolumn{2}{|p{12.5cm}|}{能夠診斷各種間質性肺疾病，執行系統性診斷評估，區分可治療與不可治療病因，制定個別化治療方案，並監測疾病進展。} \\
\hline
\textbf{核心能力} & 臨床評估 & 漸進性呼吸困難、乾咳、杵狀指評估 \\
\cline{2-3}
& 影像判讀 & HRCT型態識別、蜂窩肺、磨玻璃影 \\
\cline{2-3}
& 病因分析 & 藥物性、職業性、自體免疫相關ILD \\
\cline{2-3}
& 診斷程序 & 支氣管肺泡沖洗、肺切片適應症 \\
\cline{2-3}
& 功能監測 & DLCO、6分鐘走路測試、生活品質 \\
\cline{2-3}
& 治療策略 & 抗纖維化藥物、免疫抑制治療 \\
\cline{2-3}
& 進展評估 & 疾病惡化識別、肺移植評估 \\
\hline
\textbf{Level 1} & Novice & 能識別ILD可能性，了解基本影像特徵 \\
\hline
\textbf{Level 2} & Advanced Beginner & 能執行基本診斷評估，識別常見ILD類型 \\
\hline
\textbf{Level 3} & Competent & 能獨立診斷主要ILD類型，制定治療計畫 \\
\hline
\textbf{Level 4} & Proficient & 能處理複雜ILD個案，整合多學科討論 \\
\hline
\textbf{Level 5} & Expert & 成為ILD專家，處理罕見疾病與併發症 \\
\hline
...
\begin{importantbox}
\textbf{特別提醒：} 胸腔內科EPAs的評量重點在於漸進式能力發展，而非單次完美表現。鼓勵從錯誤中學習，持續改進。每個EPA都需要在真實臨床情境中反復練習與評量。新增的4個EPAs（結核病、NTM、肺癌、間質性肺病）特別需要長期追蹤個案來建立臨床經驗。
\end{importantbox}

\subsection{評量工具對應表}
\begin{table}[h]
    \centering
    \caption{各EPA推薦評量工具（更新版）}
    \begin{tabular}{p{4.5cm} p{4cm} p{5.5cm}}
        ...
        \midrule
        \textcolor{emergency_red}{複雜疾病管理類} & \textcolor{emergency_red}{Portfolio-based} & \textcolor{emergency_red}{長期個案追蹤} \\
        \textcolor{emergency_red}{(EPA 11, 12, 13, 14)} & \textcolor{emergency_red}{Assessment} & \textcolor{emergency_red}{多科團隊評量} \\
        \bottomrule
    \end{tabular}
\end{table}

\subsection{評量頻率建議（更新版）}
\begin{itemize}[nosep]
    \item \textbf{每月評量}：選擇3-4個EPA重點評量（包括1個新增EPA）
    \item \textbf{季度檢討}：全面檢視所有14個EPA進展
    \item \textbf{年度認證}：EPA達標認證與進階規劃
    \item \textbf{即時回饋}：發現學習需求時立即介入
    \item \textbf{長期追蹤}：EPA 11-14需要至少6個月的個案追蹤
\end{itemize}

\vspace{0.5cm}
\note{
新增的4個EPAs（結核病、NTM、肺癌、間質性肺病）由於疾病複雜度高且治療週期長，建議採用Portfolio-based Assessment方式，要求學員至少完整追蹤3-5個相關個案，並定期進行多專科團隊討論。這些EPA的評量重點在於疾病管理的完整性與持續性，而非單一技能的熟練度。
}

\section{實施建議與學習資源（擴展版）}

\subsection{月度晨會Mini-OSCE整合建議（更新版）}
\begin{table}[h]
    \centering
    \caption{月度EPA評量主題安排（14個EPA版本）}
    \begin{tabular}{p{2.5cm} p{4.5cm} p{7cm}}
        ...
        第4個月 & EPA 9, 10 & 進階技能與整合能力 \\
        第5個月 & \textcolor{emergency_red}{EPA 11, 12} & \textcolor{emergency_red}{分枝桿菌感染診療} \\
        第6個月 & \textcolor{emergency_red}{EPA 13, 14} & \textcolor{emergency_red}{肺癌與間質性肺病} \\
        第7-12個月 & 綜合評量與進階訓練 & 複雜個案整合處理能力 \\
        \bottomrule
    \end{tabular}
\end{table}

\subsection{推薦學習資源（擴展版）}
學員可參考以下文獻深入學習：

\textbf{基礎教科書：}
\begin{itemize}
    \item Murray \& Nadel's Textbook of Respiratory Medicine. 7th edition.
    \item Fishman's Pulmonary Diseases and Disorders. 5th edition.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textcolor{emergency_red}{WHO Guidelines for Treatment of Drug-Resistant Tuberculosis (2022)}
    \item \textcolor{emergency_red}{ATS/ERS/ESCMID/IDSA Guidelines for NTM Disease (2020)}
    \item \textcolor{emergency_red}{NCCN Guidelines for Non-Small Cell Lung Cancer (2024)}
    \item \textcolor{emergency_red}{ATS/ERS/JRS/ALAT Guidelines for Idiopathic Pulmonary Fibrosis (2022)}
\end{itemize}

\subsection{新增EPA專業學習建議}
\begin{table}[h]
    \centering
    \caption{新增4個EPA的專業學習重點}
    \begin{tabular}{p{2cm} p{6cm} p{6cm}}
        \toprule
        \textbf{EPA} & \textbf{核心學習內容} & \textbf{實務經驗要求} \\
        \midrule
        EPA 11 (TB) & WHO治療指引、抗藥性檢測、DOTS & 完整追蹤至少5個TB個案 \\
        EPA 12 (NTM) & ATS診斷標準、MAC治療、外科評估 & 管理至少3個NTM個案 \\
        EPA 13 (肺癌) & 分子檢測、免疫治療、緩解照護 & 參與至少10個肺癌分期討論 \\
        EPA 14 (ILD) & HRCT判讀、抗纖維化治療、肺移植 & 長期追蹤至少5個ILD個案 \\
        \bottomrule
    \end{tabular}
\end{table}

\subsection{自我評估工具（更新版）}
\begin{itemize}[nosep]
    \item 定期記錄學習歷程與反思（包括新增EPA的個案紀錄）
    \item 尋求多方回饋（主治醫師、護理師、病人、多科團隊）
    \item 參與同儕學習與討論
    \item 利用模擬教學工具練習
    \item 建立個人學習檔案
    \item \textcolor{emergency_red}{建立長期個案追蹤紀錄（特別針對EPA 11-14）}
    \item \textcolor{emergency_red}{參與多專科團隊會議（腫瘤科、胸腔外科、感染科）}
\end{itemize}

\section{總結}

胸腔內科EPAs現已擴展至14個，涵蓋了呼吸系統疾病診療的完整核心能力，從基礎的病史詢問與理學檢查，到複雜的結核病管理、肺癌診療，以及間質性肺疾病的長期照護。每個EPA都有清楚的能力描述與里程碑發展路徑，協助住院醫師循序漸進地建立專業能力。

\begin{importantbox}
\textbf{關鍵訊息：} 擴展版胸腔內科EPAs的核心在於「可委託性」與「完整性」。新增的4個EPAs（結核病、NTM、肺癌、間質性肺病）代表胸腔內科醫師必須具備的進階診療能力。這些疾病通常需要長期管理、多專科合作，以及個案追蹤經驗的累積。當您能夠安全、穩立地執行所有14項呼吸系統疾病診療活動，並做出合理的臨床決策時，就達到了相對應EPA的目標。記住，每一次的臨床實務都是學習的機會，透過持續的實作、反思與改進，並積極參與長期個案追蹤與多專科團隊討論，才能成為一位優秀的胸腔內科醫師。
\end{importantbox}
...
\bibitem{ats2020ntm}
Daley, C. L., et al. (2020). Treatment of nontuberculous mycobacterial pulmonary disease: an official ATS/ERS/ESCMID/IDSA clinical practice guideline. \textit{Clinical Infectious Diseases}, 71(4), e1-e36.

\bibitem{nccn2024}
National Comprehensive Cancer Network. (2024). NCCN Clinical Practice Guidelines in Oncology: Non-Small Cell Lung Cancer. Version 3.2024.

\bibitem{ats2022ipf}
Raghu, G., et al. (2022). Diagnosis and treatment of idiopathic pulmonary fibrosis. An official ATS/ERS/JRS/ALAT clinical practice guideline. \textit{American Journal of Respiratory and Critical Care Medicine}, 205(9), e18-e47.

\bibitem{fishman2023}
Grippi, M. A., et al. (2023). \textit{Fishman's Pulmonary Diseases and Disorders}. 5th edition. McGraw Hill.
